...
# LTI.
if settings.FEATURES.get('ENABLE_AS_LTI_TOOL_PROVIDER'):
    urlpatterns += (
        url(r'^courses/{}/jump_to_lti/(?P<location>.*)$'.format(settings.COURSE_ID_PATTERN),
            'courseware.views.jump_to_lti', name="jump_to_lti"),
    )
